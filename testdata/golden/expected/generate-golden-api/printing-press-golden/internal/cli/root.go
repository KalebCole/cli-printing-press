...
type rootFlags struct {
	...
	// invocation. Mirrors the PRINTING_PRESS_GOLDEN_NO_LEARN env var.
	noLearn bool
...
Run 'printing-press-golden-pp-cli doctor' to verify auth and connectivity.`,
	...
	rootCmd.PersistentFlags().StringVar(&flags.runProfileName, "profile", "", "Apply values from a saved run profile; this does not select a client (see 'printing-press-golden-pp-cli profile list')")
