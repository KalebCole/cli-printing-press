...
type rootFlags struct {
	...
	// invocation. Mirrors the FASTAPI_OPERATIONIDS_GOLDEN_NO_LEARN env var.
	noLearn bool
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "fastapi-operationids-golden-pp-cli",
		Short: "Manage fastapi-operationids-golden resources via the fastapi-operationids-golden API",
...
Run 'fastapi-operationids-golden-pp-cli doctor' to verify auth and connectivity.`,
	...
	rootCmd.SetVersionTemplate("fastapi-operationids-golden-pp-cli {{ .Version }}\n")
